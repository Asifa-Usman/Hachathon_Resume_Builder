...
var resumePg = document.getElementById("resumePage");
var resumepic = document.getElementById("resumePic");
...
from.addEventListener("submit", function (event) { return __awaiter(_this, void 0, void 0, function () {
    var name, email, phone, degree, education, workExperience, skills, picInput, picfile, photoBase64, queryParams, url;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                picfile = picInput.files ? picInput.files[0] : null;
                photoBase64 = '';
                if (!picfile) return [3 /*break*/, 2];
                return [4 /*yield*/, fileToBase64(picfile)];
            case 1:
                photoBase64 = _b.sent();
            ...
            case 2:
                ...
                url = "".concat(window.location.origin, "?").concat(queryParams.toString());
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    var degree = queryParams.get('degree') || '';
    var education = queryParams.get('education') || '';
    var workExperience = queryParams.get('workExperience') || '';
    ...
    if (name || email || phone || degree || education || workExperience || skills) {
        ...
        resumeWorkExperience.textContent = workExperience;
        resumeSkills.textContent = skills;
        var savedpic = localStorage.getItem("resumePic");
        if (savedpic) {
